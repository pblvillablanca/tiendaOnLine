...
Router.post('/existeUsuarioRc',(req,res)=>{

	res.header("Access-Control-Allow-Origin", "*");
  	res.header("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept");

	let bodyRequestFinal = JSON.stringify(req.body);

	let jsonRequest = JSON.parse(bodyRequestFinal);
...
Router.post('/buscarProductoMatchRc',(req,res)=>{
...
Router.get('/obtenerProductosRc',(req,res)=>{
...
Router.post('/obtenerProductoRc',(req,res)=>{
...
Router.post('/agregarCarritoRc',(req,res)=>{
...
Router.get('/obtenerNumProdCarritoRc',(req,res)=>{
...
Router.get('/obtenerProductosCarritoRc',(req,res) => {
...
Router.get('/eliminarProductosCarritoRc',(req,res)=>{
